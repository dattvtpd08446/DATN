...
const BannerHome = ({ type }) => {
  const banners = [
    { src: "../images/banner/banner1.png", name: "Banner 1", title: "Title 1" },
    { src: "../images/banner/banner5.png", name: "Banner 2", title: "Title 2" },
    { src: "../images/banner/banner3.png", name: "Banner 3", title: "Title 3" }
  ];
  const settings = {
    arrows: false,
    // dots: true,
