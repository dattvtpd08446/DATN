  ...
  if (isLargerThan1100) {
            ...
            <MenuList bg="#FFF">
              ...
              >
                <Box>
                  ...
                  >
                    <Image
                      w={100} // Đặt chiều rộng của ảnh
                      h={100} // Đặt chiều cao bằng với chiều rộng để tạo hình tròn
                      marginLeft={5} // Khoảng cách lề trái
                      borderRadius="50%" // Bo tròn ảnh 100%
                      objectFit="cover" // Đảm bảo ảnh lấp đầy vùng chứa mà không bị biến dạng
                      src={require("../Components/Images/111111.jpg")}
                    />
                    <Link to="/lau">
                      {" "}
                      <Text> Các món lẩu</Text>
                    </Link>
                  </Heading>
                  <Link to="/">
                    {" "}
                    <Text className="hoverText">Lẩu cá mú nấu ngót</Text>
                  </Link>
                  <Link to="">
                    <Text className="hoverText"> Lẩu cá kèo</Text>
                  </Link>
                  <Link to="">
                    <Text className="hoverText">Lẩu bò</Text>
                  </Link>
                  <Link to="">
                    {" "}
                    <Text className="hoverText">Lẩu vịt nấu chao</Text>
                  </Link>
                </Box>
                <Box>
                  <Heading className="hoverText" my="8px" fontSize={"18px"}>
                    <Image
                      ...
                      borderRadius="50%" // Bo tròn ảnh 100%
                      objectFit="cover" // Đảm bảo ảnh lấp đầy vùng chứa mà không bị biến dạng
                      src={require("../Components/Images/haisan.png")}
                    />
                    <Link to="haisan">
                      {" "}
                      <Text>Các món hải sản</Text>
                    </Link>
                  </Heading>
                  <Link to="apple/phone">
                    <Text className="hoverText">Tôm sốt thái</Text>
                  </Link>
                  <Link to="samsung">
                    {" "}
                    <Text className="hoverText">Nghêu hấp xả</Text>
                  </Link>
                  <Link to="xiaomi">
                    {" "}
                    <Text className="hoverText">Sò điệp nướng phô mai</Text>
                  </Link>
                  <Link to="oppo">
                    {" "}
                    <Text className="hoverText"> Mực nướng muối ớt</Text>
                  </Link>
                </Box>
                <Box>
                  <Heading className="hoverText" my="8px" fontSize={"18px"}>
                    <Link to="ga">
                      <Image
                        w={100} // Đặt chiều rộng của ảnh
                        h={100} // Đặt chiều cao bằng với chiều rộng để tạo hình tròn
                        marginLeft={8} // Khoảng cách lề trái
                        borderRadius="50%" // Bo tròn ảnh 100%
                        objectFit="cover" // Đảm bảo ảnh lấp đầy vùng chứa mà không bị biến dạng
                        src={require("../Components/Images/ga.jpg")}
                      />
                      <Text> Các món về gà, bò</Text>
                    </Link>
                  </Heading>
                  <Link to="tablet">
                    {" "}
                    <Text className="hoverText"></Text>
                  </Link>
                  <Link to="tablet">
                    {" "}
                    <Text className="hoverText"> Gà chiên nước mắm </Text>
                  </Link>
                  <Link to="tablet">
                    {" "}
                    <Text className="hoverText">Gà kho xả ớt</Text>
                  </Link>
                  <Link to="tablet">
                    {" "}
                    <Text className="hoverText"> Gà luộc </Text>
                  </Link>
                </Box>
                <Box>
                  <Heading
                  ...
                  >
                    <Image
                      ...
                      borderRadius="50%" // Bo tròn ảnh 100%
                      objectFit="cover" // Đảm bảo ảnh lấp đầy vùng chứa mà không bị biến dạng
                      src={require("../Components/Images/com.png")}
                    /> 
                    <Link to="com">
                    <Text> Cơm</Text>
                    </Link>
                  ...
                  <Link to="com">
                    {" "}
                    <Text className="hoverText"> Cơm chiên cá mặn</Text>
                  </Link>
                  <Link to="cable">
                    {" "}
                    <Text className="hoverText"> Cơm chiên bò </Text>
                  </Link>
                  {/* <Link to="EarPhone">
                    {" "}
                    <Text className="hoverText"> </Text>
                ...
                <Box>
                  <Heading className="hoverText" my="8px" fontSize={"18px"}>
                    <Image
                      ...
                      borderRadius="50%" // Bo tròn ảnh 100%
                      objectFit="cover" // Đảm bảo ảnh lấp đầy vùng chứa mà không bị biến dạng
                      src={require("../Components/Images/nuocuong.png")}
                    />
                    <Link to="water">
                    <Text> Nước uống</Text>
                    </Link>
                  ...
                  <Link to="water">
                    {" "}
                    <Text className="hoverText"> Coca</Text>
                  </Link>
                  <Link to="keyboard">
                    {" "}
                    <Text className="hoverText">Nước suối</Text>
                  </Link>
                  <Link to="LoudSpeaker">
                    {" "}
                    <Text className="hoverText">7Up</Text>
                  </Link>
                </Box>
              </Grid>
            </MenuList>
          ...
          <Menu>
            <Link to="com">
              <MenuButton
                ...
                _focus={{ boxShadow: "0px 3px 0px  #555" }}
              >
                <Icon boxSize={5} h={5} as={FaBowlRice} /> Cơm
              </MenuButton>
            </Link>
          </Menu>
          <Menu>
          ...
          <Menu>
            <Link to="water">
              <MenuButton
                ...
                display="flex"
              >
                <Icon as={GiWaterBottle} /> Nước uống
              </MenuButton>
            </Link>
          </Menu>
        </Flex>
    ...
    return (
      ...
      >
        <Link to="/">
          <Box>
            <Image src={require("./Images/pud.png")} alt="logo" w="120px" />
          </Box>
        </Link>
        <Box>
          <Flex
    ...
    return (
      ...
      >
        <Link to="/">
          <Box marginLeft={0}>
            <Image src={require("./Images/pud.png")} alt="logo" w="100px" />
          </Box>
        </Link>
        <Box paddingLeft={2}>
          <Flex
